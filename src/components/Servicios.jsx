...
function Servicios() {
  return (
    <div class="flex  bg-gray flex-col items-center h-[130vh] ">
      <div className="flex flex-wrap justify-center px-[100px]  h-[60vh]">
        <div className="w-full flex justify-center title-container">
          <h1 id="servicios" className="text-3xl font-bold text-blue-100 ">
            Servicios
          </h1>
        </div>
        <div className="w-full sm:w-1/2 md:w-1/4 p-2 h-[300px] mt-2 flex items-center">
          <div className="bg-white rounded-lg shadow-md p-4 w-full cardHeight ">
        ...
        <div className="w-full sm:w-1/2 md:w-1/4 p-2 flex items-center">
          <div className="bg-white rounded-lg shadow-md p-4 w-full cardHeight ">
      ...
      <div className="flex flex-wrap justify-center px-[100px]">
        ...
        <div className="w-full sm:w-1/2 md:w-1/4 p-2 h-[380px] flex items-center">
          <div className="bg-white rounded-lg shadow-md p-4 w-full cardHeight ">
            <h3 className="text-lg font-semibold mb-2">
